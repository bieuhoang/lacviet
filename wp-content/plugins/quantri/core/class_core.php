...
class DaiLy_Core {
  ...
  function admin_menu() {
    ...
    $quanly_daily[ 'system' ][ 'pages' ][ 'naptien' ] = add_submenu_page( 'quanly_daily', __( 'All People', 'quanly_daily' ), __( 'Thêm mới khách hàng', 'quanly_daily' ), 'WP-CRM: View Overview', 'themmoikhachhang', array( 'DaiLy_Core', 'page_loader' ) );    
    $quanly_daily[ 'system' ][ 'pages' ][ 'naptien' ] = add_submenu_page( 'quanly_daily', __( 'All People', 'quanly_daily' ), __( 'Quản lý nạp tiền', 'quanly_daily' ), 'WP-CRM: View Overview', 'naptien', array( 'DaiLy_Core', 'page_loader' ) );
